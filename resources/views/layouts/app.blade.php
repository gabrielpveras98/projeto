...
@else
    ...
    <div class="wrapper wrapper-full-page">
        <div class="full-page {{ $contentClass ?? '' }}" style="background-color: #d725bb">
            <div class="content">
                <div class="container">
                    @yield('content')
                </div>
    ...
    <div class="dropdown show-dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="button-container">
                ...
                <a href="https://white-dashboard-laravel.creative-tim.com/docs/getting-started/laravel-setup.html"
            ...
            <li class="button-container text-center">
                ...
                <br>
                <br>
                <a class="github-button" href="https://github.com/creativetimofficial/white-dashboard-laravel"
